...
{
   char ch;
   trapFile.open("/Users/iitmarty/Pep-8.12/Pep8Term/trap");
   if (!trapFile.is_open()) {
      bError = true;
...
void InstallRom (bool& bError)
{
   ...
   int iCounter = 0;
   char cNext;
   ROMFile.open("/Users/iitmarty/Pep-8.12/Pep8Term/pep8os.pepo");
   if (ROMFile.fail())
   {
      bError = true;
...
int main (int argc, char *argv[])
{
   ...
   if (argc == 2)
   {
      ...
      {
         cout << "Pep/8 Simulator, version UNIX 8.1, Pepperdine University" << endl;
      }
      else
      {
